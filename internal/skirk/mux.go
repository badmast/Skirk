...
const (
	...
	muxNormalLaneQueueBytes      = 4 * 1024 * 1024
	muxNormalStreamQueueBytes    = 2 * 1024 * 1024
	muxUrgentUploadQueue         = 32
	muxNormalUploadQueue         = 1
	muxStreamInbound             = 64
	muxStreamInboundPause        = muxStreamInbound * 3 / 4
	muxReceiveQueue              = 8192
	muxNormalReceiveQueueBytes   = 8 * 1024 * 1024
	muxNormalReceiveGlobalBytes  = 16 * 1024 * 1024
	muxPendingStreamBytes        = 4 * 1024 * 1024
	muxPendingGlobalBytes        = 16 * 1024 * 1024
